...
- 2026-08-28—**Page six (#753, mergepath) opened as [#848](https://github.com/nathanjohnpayne/nathanpaynedotcom/pull/848).** Five decisions, four constraints, one learning. Delta audit §E28–§E62, thirty-five rows, pinned to `mergepath@3d961050e203e8b7a55bb551e89aa4da834356f6`. Prose 1,531 → 1,311 words (−14.4%), a restructure rather than an expansion. The figure moved every round—1,190 at the build commit, 1,228 after round 1, 1,261 after round 2, 1,311 after round 3—because every correction narrows a claim and narrowing costs words. Recount immediately before merge; Codex caught this entry stale once already, and the shrink has now given back a third of itself to accuracy.
