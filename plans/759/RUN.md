...
|---|-------|------|---------------|-------------|--------|----|--------|
| 0 |—| shared evidence cache | **0 complete** | `plans/759/refs.json` | `content/740-astro-migration-audit` |—| done |
| 1 | #740 | how-a-responsive-fix-became-an-astro-migration | 3 in progress | `plans/759/how-a-responsive-fix-became-an-astro-migration-ledger.md` | `content/740-astro-migration-audit` |—| in review |
