...
| 8 | #758 | `friends-and-family-billing` | §C | decisions, constraints | [#PENDING] | **open**—4 decisions, 4 constraints, no learnings; delta audit §C23–§C50 (28 rows) pinned to `friends-and-family-billing@d70aa8a`. Taken out of table order at the operator's direction, ahead of #755 and #756 |
