...
- **The coin hypothesis is a before-and-after**—that coins and unlocks lengthened sessions or brought people back. There is no before. The mechanic landed in `4cb6671` (2026-02-27T19:59:18−0800) and `4453e74` (2026-02-27T20:18:38−0800), 3 days 9 hours 59 minutes after the initial commit, and no flag, variant, cohort or A/B exists anywhere in the tree at `7909892`, so nothing in the data separates a coin session from a pre-coin one. **This row originally said every session GA4 has ever recorded is a session with coins in it, and §G28 retires that** (Codex P2, PR #836): the app was live and instrumented for the 3 d 10 h before the mechanic landed, so any traffic in that window produced coin-free sessions. The before-period is unexamined rather than absent, and the comparison was available for three days and was never set up to be run.
