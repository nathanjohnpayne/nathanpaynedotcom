...
const homepageProjectDescriptions = [
  ...
  'A swipe-based discovery experiment for Disney+ and Hulu that turns recommendation training and watchlist building into a game—built in vanilla JS across three days.',
