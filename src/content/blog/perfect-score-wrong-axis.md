...
Over all 134 threads, the dispositions—with one relabeling declared: the marker class behind the first row is `addressed-elsewhere`, rendered here as "addressed" because all 111 replies name a fix commit:
