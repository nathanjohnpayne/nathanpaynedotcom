...
The honest answer was no. My site's colors had been verified against the live CSS, which is ground truth. The 1921 palette traced to exactly one source, my marketing poster. And the 1930 values traced to nothing but training data. So Claude went and got primary sources: the Dallas Museum of Art's official digitization of the 1921 painting (accession 1984.200.FA) and a high-resolution scan of *Composition II in Red, Blue, and Yellow*, 1930. It sampled both with robust medians across the plane pixels—468,315 of them for the 1930 red alone—to rule out highlight artifacts.
