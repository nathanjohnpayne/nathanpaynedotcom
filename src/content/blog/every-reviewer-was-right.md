...
The operating rules that came out of this started, within a day, as a twelve-rule document with a threshold: two consecutive findings in reviewer-induced machinery should trigger removal. One merged control would have tripped it at round 7, three rounds before its author acted, and it was dropped anyway, for the reason above: a count can be satisfied without anyone thinking. The rule is now that one question, and the document says that automating it into something that feels answered would defeat it.
