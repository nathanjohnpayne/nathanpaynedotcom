...
Like the rest of the portfolio, FFB runs on the [multi-agent code review pipeline](https://github.com/nathanjohnpayne/friends-and-family-billing/blob/main/REVIEW_POLICY.md) first developed for [Override](/projects/override/)—and in many ways it pressure-tested that system before I had it fully nailed down.
