...
![The template as the editor draws it, from the repository's own end-to-end harness on invented data: tokens unresolved, payment methods a placeholder block. The editor renders its own document rather than the output, which is the one clause of the brief that asked for an editor reflecting final output—still unmet.](/images/projects/friends-and-family-billing-edit.png)
