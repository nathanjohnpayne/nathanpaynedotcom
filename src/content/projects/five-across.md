...
The standings survived—frozen in the production Firestore, with the app's own final share card intact—so the bet can be scored. The card traced the novelty arc the bet was placed against: the embark tutorial drew 27 bingos from eleven players, and the next two cards managed one apiece all cruise. What became the running bit was the scoreboard, not the card—of 517 sessions over ten days, 77% contained no mark at all, people opening the app just to read the feed and check the standings—while the social mechanics built for exactly that audience collapsed: hearts and doubts each traced to a single player, and 7 of 48 reshuffles were spent. The core loop stayed broad—fourteen of sixteen players marked, nine on five or more days, 845 squares and 61 bingos, zero blackouts—and the endgame's deliberate scarcity earned its keep: the 23:00 freeze pulled 36% of the cruise's marks into the final day, the biggest of the trip, three cards claiming their first bingo hours before the deadline, days after their ports. Zacaria Arab took the title on 16 bingos; Logan Murdock out-marked him, 129 squares to 124, and finished second because the board sorts bingos first—the rule, not volume, crowned the champion.
