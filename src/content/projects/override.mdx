...
cardDescription: "Broadway financing turned from static documents into an interactive model of the deal—built as an AI coding experiment, and still untested on a real capitalization."
