...
11. The Selected Projects `STACK` ribbon is a five-rung degradation ladder, not a fixed list. Every rung stays on one line by showing as many items as the ribbon's measured width holds. Because the Mondrian square is sized from viewport **height**, a fixed list cannot do this: the ribbon measures 583px at 1440×900 and 897px at 2560×1330, so a list picked for one is wrong for the other. The rungs, longest first, are:
